...
public class FormCuenta extends javax.swing.JFrame {
    ...
    private void depositar(Cuenta cuenta,double monto) {
        ...
        context.depositarDinero(cuenta, x);
        
        double resultado;
        resultado = context.mostrarSaldo(cuenta.getSaldoInicial());
        Double.parseDouble(cuenta);
        //double resultado = cuentaProxy.depositarDinero(c,50);
